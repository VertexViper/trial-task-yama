                ...
                <div className="flex justify-center items-center mt-3 w-full">
                    <div className="flex flex-col gap-4">
                        <Link
                            href="/portfolio"
                        >
                            <Button variant={"ghost"} className="w-[120px]" disabled={!isConnected}>Portfolio</Button>
                        </Link>
                        <Link
                            href={isConnected?"/swap":"portfolio"}
                        >
                            <Button variant={"ghost"} className="w-[120px]" disabled={!isConnected}>Swap</Button>
                        </Link>
                    </div>
                </div>
            </div>
